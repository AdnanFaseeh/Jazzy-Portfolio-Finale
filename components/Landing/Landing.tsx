    ...
    <motion.main variants={slideUp} initial="initial" animate="enter" className="relative flex h-screen overflow-hidden bg-white">
      ...
      <div className="absolute top-[calc(100vh-350px)]">
        <div ref={slider} className="relative whitespace-nowrap">
          <p ref={firstText} className="gradient-text text-[230px] font-semibold pr-12">Freelance Jazzy@ -</p>
          <p ref={secondText} className="gradient-text text-[230px] font-semibold pr-12 absolute left-full top-0">Freelance Jazzy@ -</p>
        </div>
      </div>
